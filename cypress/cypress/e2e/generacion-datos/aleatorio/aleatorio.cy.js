...
/**
 * Pruebas aleatorias de Ghost 3.41.1 de Tags y Staff
 */
context("Pruebas aleatorias de Ghost 3.41.1 de Tags y Staff", () => {
  ...
  it("31. Crear Tag con name valido y Description naughty", () => {
    ...
    cy.wait(1000);
    let name = fakerEnglish.string.sample();
    cy.get("#tag-name").type(name);
    let description = fakerEnglish.helpers.arrayElement(naughty);
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn31`);
  });
  ...
  it("32. Crear Tag con Slug naughty", () => {
    ...
    let name = fakerEnglish.string.sample();
    cy.get("#tag-name").type(name);
    let slug = fakerEnglish.helpers.arrayElement(naughty);
    cy.get("#tag-slug").type(slug);
    let description = fakerEnglish.string.sample({ min: 100, max: 500 });
    cy.get("#tag-description").type(description, {
      parseSpecialCharSequences: false,
    });
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn32`);
  });
  ...
  it("33. Crear Tag con Slug texto con espacios", () => {
    ...
    let name = fakerEnglish.string.sample();
    cy.get("#tag-name").type(name);
    let slug = fakerEnglish.lorem.sentence();
    cy.get("#tag-slug").type(slug);
    let description = fakerEnglish.string.sample({ min: 100, max: 500 });
    cy.get("#tag-description").type(description, {
      parseSpecialCharSequences: false,
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn33`);
  });
  ...
  it("34. Crear Tag con Slug extenso", () => {
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn34`);
  });
  ...
  it("36. Crear Staff user con email aleatorio valido", () => {
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn36`);
  });

  it("37. Crear Staff user con email naughty", () => {
    cy.get("a[href='#/staff/']").click();
    cy.get("span").contains("Invite people").click();
    let email = fakerEnglish.helpers.arrayElement(naughty);
    cy.get("#new-user-email").type(email);
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn37`);
  });

  it("38. Crear Staff user con email extenso", () => {
    cy.get("a[href='#/staff/']").click();
    cy.get("span").contains("Invite people").click();
    let email = fakerEnglish.string.sample({ min: 100, max: 500 });
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn38`);
  });
  ...
  it("39. Crear Staff user con email duplicado", () => {
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn39`);

    fakerEnglish.seed(351515);
  });

  it("40. Crear Staff user con email URL", () => {
    cy.get("a[href='#/staff/']").click();
    cy.get("span").contains("Invite people").click();
    let email = fakerEnglish.internet.url();
    cy.get("#new-user-email").type(email + "@gmail.com");
    ...
    cy.screenshot(`aleatorio/${timestamp}/scn40`);
  });
});
